...
loco();
function textScrollAnimPage2(params) {
  var clutter = "";
  document
...
gsap.to(".page7-sir-inner", {
  scrollTrigger: {
    trigger: `.page7-sir-inner`,
    start: `top center`,
    end: `bottom top`,
    scroller: `#main`,
    scrub: 0.5,
